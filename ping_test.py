#!/usr/bin/env python3
#SHEBANG is what tells the kernel what interperter to employ when running a file's command
...
#Closing of the program with a beutiful message
print("Thank you for using this program! Gooooodbyeeeee.")
